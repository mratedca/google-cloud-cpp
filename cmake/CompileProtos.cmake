...
macro (google_cloud_cpp_find_proto_include_dir VAR)
    ...
    if (TARGET libprotobuf)
        get_target_property(PROTO_INCLUDES libprotobuf INCLUDE_DIRECTORIES)
        message(STATUS "Including libprotobuf directory from target: ${PROTO_INCLUDES}")
        foreach(dir ${LIBA_INCLUDES} ${PROTO_INCLUDES})
            list(INSERT PROTOBUF_IMPORT_DIRS 0 ${dir})
        endforeach()
        # Assign var.
        list(GET PROTO_INCLUDES 1 ${VAR})
    elseif (${VAR})
        message(STATUS "Including libprotobuf directory from found package.")
